              ...
              return (
                <div key={plan.id} className="flex flex-col">
                  <div className="flex justify-between items-baseline">
                    ...
                    <span className="text-sm text-gray-700 font-bold">{t("restaurant.up_to_people", { count: plan.guests })}</span>
                  </div>
                  <p className="text-sm text-gray-500">{t(`restaurant.seating.${plan.name}`, { defaultValue: t("restaurant.seating.default") })}</p>
                </div>
              );
            })}
          </div>
