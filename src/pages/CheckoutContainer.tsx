...
import CheckoutSummaryPage from './CheckoutSummary'
import CheckoutContact from './CheckoutContact'
import CheckoutEventDetails from './CheckoutEventDetails'
import CheckoutStepsPreview from './CheckoutSteps'
...
const CheckoutContainerInner: React.FC<{ location: Location; restaurantSlug: string }> = ({
  location,
  restaurantSlug,
}) => {
...
const CheckoutContainer: React.FC = () => {
  ...
  return <CheckoutContainerInner location={location} restaurantSlug={slug ?? ''} />
}
